<template>
  <el-header :style="'margin-bottom:'+ headerBottom +'px'">
    <h2 class="logo" style="margin-bottom: 20px;">
      <img src="../../assets/logo/logo.png" style="width: 50px;position: relative; top: 13px;right: 6px">
      <p style="display: inline-block;">个人博客</p>
    </h2>
    ...
    data() {
      return {
        ...
        },
        {
          id: 3,
          authName: '公告',
          path: '/cms/main/Gonggao',
          icon: 'el-icon-document',
        },
        {
          id: 4,
          authName: '我的日记',
          path: '/cms/main/loginStory',
...
<style scoped>
  ...
  .user-avatar {
    float: left;
    cursor: pointer;
    border: dashed rgba(#ffff7f, alpha 0.5);
  }
