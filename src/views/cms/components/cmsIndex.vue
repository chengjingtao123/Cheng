<template>
  <el-row :gutter="20">
    <!-- 走马灯 -->
    <el-carousel :interval="4000" type="card" height="300px" width="100%" autoplay style="border-radius: 10px;">
      <el-carousel-item v-for="item in 4" :key="item">
        <h3 class="medium">{{ item }}</h3>
      </el-carousel-item>
    </el-carousel>

    <el-col :sm="2" class="hidden-xs-only" style="opacity:1;">
      <el-button @click="drawer = true"
        style="margin-left: -10px;color: white;background-color: #7f7f7f;font-weight: bold;">
        查看日历
      </el-button>
    ...
    <el-col :xs="24" :sm="15">
      <el-card style="background-color: rgba(255,255,255,0.9); opacity: 0.8;box-shadow: 0 0 5px 5px #999"
        class="left-item">
    ...
    <el-col :xs="24" :sm="5" style="opacity: 0.8;">
      <el-card style="background-color: rgba(255,255,255,0.9);box-shadow: 0 0 5px 5px #999" class=" right-item">
    ...
    <el-col :sm="2" class="hidden-xs-only" style="opacity:1;">
      <iframe style="pointer-events:none;background-color: #d3dce6;border-radius: 5px;" allowtransparency="true"
        frameborder="0" width="100" height="36" scrolling="no"
        src="//tianqi.2345.com/plugin/widget/index.htm?s=3&z=3&t=1&v=0&d=3&bd=0&k=&f=&ltf=009944&htf=cc0000&q=1&e=1&a=1&c=54511&w=180&h=36&align=center"></iframe>
    </el-col>
    <!-- 右侧占位 -->
  </el-row>
</template>
