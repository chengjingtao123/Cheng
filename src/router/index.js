...
export const constantRoutes = [{
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            path: 'Gonggao',
            component: (resolve) => require(['@/views/cms/components/cmsGonggao'], resolve),
            name: 'Gonggao',
            meta: {
              title: '公告',
            }
          ...
          {
            path: 'loginStory',
            component: (resolve) => require(['@/views/cms/components/loginStory'], resolve),
            name: 'loginStory',
            meta: {
              title: '我的日记',
            }
  ...
  // 
  {
    path: '/components/cmsMyStory',
    component: (resolve) => require(['@/views/cms/components/cmsMyStory'], resolve),
    hidden: true,
  },
// 
  {
